...
final class DeviceTypeRepository
{
    ...
    public function create(array $data): void
    {
        ...
        if ($manufacturer === '' || $model === '') {
            throw new \InvalidArgumentException('Hersteller und Modell sind erforderlich.');
        }
        if (!is_numeric($data['tx_power_dbm'] ?? null)) {
            throw new \InvalidArgumentException('TX Power muss numerisch sein.');
        }
